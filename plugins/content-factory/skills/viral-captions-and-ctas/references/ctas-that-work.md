...
Choose CTA from declared objective. Sends, saves, meaningful comments,
...
5. **Keyword comment**. Valid when it requests a named artifact, active DM
   automation delivers exact promise, and conversion is measured.
...
Measure qualified keyword comments and successful deliveries. Flag only empty
engagement demands, deceptive delivery, or multi-ask spam.
...
- "Comment YES for the link" → name the artifact and use a collision-safe keyword,
