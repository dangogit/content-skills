...
Fill this in per platform. The visible portion is the headline. Treat
it as one. See `references/caption-craft.md` for the rules.
...
SECONDARY TERMS (1–2, woven in naturally):
  - [term 1]
  - [term 2]
...
HASHTAGS (small relevant set, verify current behavior):
  #[niche-tag] #[niche-tag] #[niche-tag]
...
- [ ] Visible line lands before the platform's cutoff.
- [ ] Primary keyword appears once, early.
- [ ] Hashtags are relevant; current platform limits verified.
- [ ] One primary action, not three.
- [ ] Caption doesn't echo the on-screen hook verbatim.
- [ ] Run through `bait-check.md` before shipping.
