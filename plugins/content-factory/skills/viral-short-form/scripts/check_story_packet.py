#!/usr/bin/env python3
"""Mechanical gate for a short-form story packet."""
...
def check_packet(text: str) -> list[str]:
    ...
    for label in ("Objective", "Audience", "Story role", "Proof", "Selected spine", "Experiment"):
...
def main() -> int:
    ...
    if errors:
        for error in errors:
            print(f"FAIL: {error}")
        return 1
    print("PASS: short-form story mechanics")
    return 0
